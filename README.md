...
All you are given is a radar reading and the shape of known invaders.. So you decide to pick the best tool on earth
to find the pesky invaders: Ruby!

Your goal is set, your app must:

* Take the radar sample as argument
* Reveal possible locations of those pesky invaders

Good luck! Earth depends on you!!!
